...
import { addTaskProject, deleteTaskProject } from '../../../features/tasksSlice'
import ProjectInput from './ProjectInput/ProjectInput'
import AllProjects from './AllProjects/AllProjects'
import ErrorMessage from '../ErrorMessage'

const ProjectForm = ({ value, onChange, isNewTask, taskId }) => {
  ...
  const handleProjectSelect = (projectId) => {
    ...
    if (value.includes(projectId)) {
      newSelectedProjects = value.filter((id) => id !== projectId)
      if (!isNewTask && taskId) {
        dispatch(deleteTaskProject({ id: taskId, projectId }))
      }
    } else {
      newSelectedProjects = [...value, projectId]
      if (!isNewTask && taskId) {
        dispatch(addTaskProject({ id: taskId, projectId }))
      }
    }
